...
HISTORICO DESTE TETO — duas decisoes OPOSTAS do operador, com o print de
cada uma na frente dele:

31/08/2026, teto baixado de (2,3,4,6,8) para (2,): "AUMENTE NUMERO DE RENKO,
PRECISO VER UM PERIODO MAIOR". O fator infla o TIJOLO, e tijolo mais alto e,
pelo `ASPECTO_TIJOLO`, mais LARGO, o que reduz quantos cabem na largura fixa
da regiao. Medido na tela (regiao de 568px, escala do candle ~5 px/tick):
...
01/09/2026, teto DEVOLVIDO para (2,3,4): "ABRA MAIS O GRAFICO RENKO, PARA EU
CONSEGUIR VER MELHOR ALVOS". Aqui a regiao passou de 354px para 542px de
altura, e ai o teto 2 vira o problema oposto: com mais altura e o MESMO
fator, a regiao mostra mais FAIXA DE PRECO, e os alvos A1/A2/A3 se
comprimem — no retrato da opcao so-mais-alta o rotulo "A1+ ALVO DO
COMPRADOR" chegou a sobrepor os proprios tijolos.

Os dois pedidos sao legitimos e brigam entre si na MESMA largura: tijolo
maior = alvo legivel = menos historico. O operador escolheu ALVO LEGIVEL
depois de ver os tres retratos lado a lado (ATUAL 69 tijolos/alvos
apertados, so-mais-alta 124/alvos piores, esta 69/alvos separados). Se um
dia ele quiser os dois, o caminho nao e mexer neste teto — e dar mais
LARGURA a regiao, que e a dimensao que hoje limita a contagem."""
